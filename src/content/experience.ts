...
export const experience: ExperienceEntry[] = [
  ...
  },
  {
    ...
    bullets: [
      ...
      "Architected and maintained API integrations with Meta, LinkedIn, and TikTok platforms, enabling automated data collection and marketing analytics at scale",
      "Designed and operated Python-based ETL pipelines, scheduled automation (cron jobs), and system monitoring workflows serving company-wide analytics",
      "Structured databases, data schemas, and CRM platforms to ensure scalable data organization and reporting reliability across departments",
      "Coordinated cross-functional teams, translating technical requirements between engineering, marketing, and executive stakeholders",
    ],
    skills: [
...
export const beyondTechExperience: ExperienceEntry[] = [
  {
    ...
    type: "Volunteer (inactive)",
    location: "Beirut, Lebanon",
    dateStart: "Dec 2023",
    dateEnd: "Currently inactive",
    bullets: [
      "Delivered on-site emergency medical care and executed BLS protocols",
      "Coordinated patient transport with hospitals and mentored new EMT volunteers",
    ],
