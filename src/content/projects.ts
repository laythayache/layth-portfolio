...
export const projects: Project[] = [
  {
    slug: "lancaster-websites",
    title: "Lancaster Websites",
    status: "ongoing",
    kind: "web",
    system: "hospitality",
    ui_mode: "lab",
    updated_at: "2026-09-17",
    summary: "A collection of Lancaster hospitality websites built on a shared React, Node.js and PostgreSQL platform, supporting property content and guest discovery.",
    role: "Web engineering",
    stack: "React, TypeScript, Vite, Node.js, PostgreSQL",
    links: { demo: "https://lancasterplaza.com/" },
    tags: ["Web Development", "Hospitality", "Full Stack"],
    thumbnail: "/images/work/lancaster.webp",
    featured: true,
    sections: {
      problem: "A hotel collection needs consistent, usable websites while giving each property space to present its own rooms, facilities and destination.",
      systemReality: "Lancaster properties share a common application foundation. Property content and configuration distinguish each site, while a shared approach to the interface and application structure supports consistency.",
      intervention: "Web engineering across the Lancaster website collection, covering the property interfaces and the shared platform behind them.",
      architecture: "React and Vite provide the frontend. A Node.js application and PostgreSQL support the backend and property content. The platform uses shared conventions across separate property sites.",
      tradeoffs: "A shared foundation supports consistency across properties. Property-specific content and styling allow each destination to retain its own identity.",
      worked: "Public property websites provide a place to explore accommodation, facilities and contact information. The links below open individual Lancaster properties.",
      didnt: "",
      unsolved: "",
      challenges: "",
    },
  },
  {
    ...
    ui_mode: "lab",
    updated_at: "2026-09-17",
    summary: "A public guide to Lebanese elections. Layth contributed web scraping and information gathering for the platform's searchable election information.",
    role: "Web scraping & information gathering",
    links: { demo: "https://daleel-lb.vercel.app/en" },
    tags: ["Data Collection", "Web Scraping", "Public Information"],
    thumbnail: "/images/work/daleel.webp",
    featured: true,
    sections: {
      problem: "Public election information can be spread across multiple sources, making it difficult to find relevant candidates, districts, lists and voting information in one place.",
      systemReality: "Daleel brings Lebanese election information into a searchable public guide with Arabic, English and French interfaces. The platform covers candidates, districts, lists, voting centers and election laws.",
      intervention: "My contribution focused on web scraping and information gathering: collecting the public information used by the platform. This project is presented here specifically as a data collection contribution.",
      tradeoffs: "",
      worked: "The public platform offers searchable election information and dedicated exploration pages. Visit the live site to explore the product.",
      didnt: "",
      unsolved: "",
      challenges: "",
    },
