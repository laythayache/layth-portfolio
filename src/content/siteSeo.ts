...
export function websiteJsonLd() {
  return {
    ...
    inLanguage: "en",
    description:
      "Systems Engineer and Technical Consultant specializing in workflow automation, system reliability, CRM administration, and SaaS platform management.",
    publisher: { "@id": ORG_ID },
  };
}
  ...
  return {
    ...
    "@graph": [
      ...
      faqJsonLd(),
      {
        ...
        "@id": `${SITE_URL}/#profile`,
        url: SITE_URL,
        name: "Layth Ayache | Systems Engineer & Technical Consultant",
        description:
